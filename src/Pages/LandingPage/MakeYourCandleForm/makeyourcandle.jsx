...
const CandleForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.post(`${baseUrl}/makeyourcandle/create`, formData);
    ...
    return (
        <div className="form-container">
            ...
            <p style={{color: 'deeppink', fontSize: '25px'}} align='center'>Your Personalized Candle</p>
            <p>Thank you for choosing our pers onalized candles! Please fill out the form below so we can create the
                perfect candles for you.</p>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="form-group">
                        ...
                        <div className="options">
                            <label>
                                <input type="checkbox" name="purpose" value="Baby Shower"
                                       onChange={handleInputChange}/>{" "}
                                Baby Shower
                            </label>
                            <label>
                                <input type="checkbox" name="purpose" value="Wedding Gift"
                                       onChange={handleInputChange}/>{" "}
                                Wedding Gift
                            </label>
                            <label>
                                <input type="checkbox" name="purpose" value="Corporate Event"
                                       onChange={handleInputChange}/>{" "}
                                Corporate Event
                            </label>
                            <label>
                                <input type="checkbox" name="purpose" value="Personalized Gift"
                                       onChange={handleInputChange}/>{" "}
                                Personalized Gift
                            </label>
                            <label>
                                <input type="checkbox" name="purpose" value="Birthday Party"
                                       onChange={handleInputChange}/>{" "}
                                Birthday Party
                            </label>
                            <label>
                    ...
                    <div className="form-group">
                        ...
                        <div className="options">
                            ...
                            <label>
                                <input type="radio" name="scent" value="Sweet Orange"
                                       onChange={handleInputChange}/>{" "}
                                Sweet Orange
                            </label>
                            <label>
                            ...
                            <label>
                                <input type="radio" name="scent" value="Eucalyptus & Mint"
                                       onChange={handleInputChange}/>{" "}
                                Eucalyptus & Mint
                            </label>
                            <label>
                            ...
                            <label>
                                <input type="radio" name="scent" value="Apple Cinnamon"
                                       onChange={handleInputChange}/>{" "}
                                Apple Cinnamon
                            </label>
                            <label>
                                <input type="radio" name="scent" value="Blackberry & Rose"
                                       onChange={handleInputChange}/>{" "}
                                Blackberry & Rose
                            </label>
                        </div>
                    ...
                    <div className="form-group">
                        ...
                        <div className="options">
                            <label>
                                <input type="radio" name="jar_color" value="Frosted Red"
                                       onChange={handleInputChange}/>{" "}
                                Frosted Red
                            </label>
                            <label>
                                <input type="radio" name="jar_color" value="Frosted White"
                                       onChange={handleInputChange}/>{" "}
                                Frosted White
                            </label>
                            <label>
                                <input type="radio" name="jar_color" value="Shiny Black"
                                       onChange={handleInputChange}/>{" "}
                                Shiny Black
                            </label>
                            <label>
                                <input type="radio" name="jar_color" value="Frosted Pink"
                                       onChange={handleInputChange}/>{" "}
                                Frosted Pink
                            </label>
                            <label>
                                <input type="radio" name="jar_color" value="Frosted Green"
                                       onChange={handleInputChange}/>{" "}
                                Frosted Green
                            </label>
                            <label>
                    ...
                    <div className="form-group">
                        ...
                        <div className="options">
                            <label>
                                <input type="radio" name="special_labeling" value="Yes"
                                       onChange={handleInputChange}/>{" "}
                                Yes (Please provide the message below)
                            </label>
                            <label>
                                <input type="radio" name="special_labeling" value="No"
                                       onChange={handleInputChange}/>{" "}
                                No
                            </label>
                            <textarea
                    ...
                    <div className="form-group">
                        ...
                        <div className="options">
                            <label>
                                <input type="radio" name="delivery_timeline" value="Within a week"
                                       onChange={handleInputChange}/>{" "}
                                Within a week
                            </label>
                            <label>
                                <input type="radio" name="delivery_timeline" value="1-2 weeks"
                                       onChange={handleInputChange}/>{" "}
                                1-2 weeks
                            </label>
                            <label>
                                <input type="radio" name="delivery_timeline" value="2-3 weeks"
                                       onChange={handleInputChange}/>{" "}
                                2-3 weeks
                            </label>
                            <label>
                                <input type="radio" name="delivery_timeline" value="Other"
                                       onChange={handleInputChange}/>{" "}
                                Other (please specify):{" "}
                    ...
                    <div className="form-group">
                        <p style={{color: 'deeppink', fontSize: '25px'}}>Contact Details</p>
                        <p align="left">
                            Please provide your contact information so we can get in touch with you regarding your
                            order.
                        </p>
